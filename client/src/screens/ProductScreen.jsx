          ...
          >
            ...
            >
              ...
              >
                ...
                <Stack spacing="5">
                  <Box>
                    <Text fontSize="xl">CHF{product.price}</Text>
                    <Flex>
                      <HStack spacing="2px">
                        <StarIcon color="blue.500" />
                        <StarIcon
                          color={product.rating >= 2 ? "blue.500" : "cyan.200"}
                        />
                        <StarIcon
                          color={product.rating >= 3 ? "blue.500" : "cyan.200"}
                        />
                        <StarIcon
                          color={product.rating >= 4 ? "blue.500" : "cyan.200"}
                        />
                        <StarIcon
                          color={product.rating >= 5 ? "blue.500" : "cyan.200"}
                        />
                      </HStack>
                    ...
                    <Wrap>
                      <HStack spacing="2px">
                        ...
                        <Button variant="outline" onClick={() => setRating(2)}>
                          <StarIcon
                            color={rating >= 2 ? "blue.500" : "cyan.200"}
                          />
                        </Button>
                        <Button variant="outline" onClick={() => setRating(3)}>
                          <StarIcon
                            color={rating >= 3 ? "blue.500" : "cyan.200"}
                          />
                        </Button>
                        <Button variant="outline" onClick={() => setRating(4)}>
                          <StarIcon
                            color={rating >= 4 ? "blue.500" : "cyan.200"}
                          />
                        </Button>
                        <Button variant="outline" onClick={() => setRating(5)}>
                          <StarIcon
                            color={rating >= 5 ? "blue.500" : "cyan.200"}
                          />
                        </Button>
                      </HStack>
                    </Wrap>
                ...
                {product.reviews.map((review) => (
                  <Box key={review._id}>
                    <Flex spacing="2px" alignItems="center">
                      <StarIcon color="blue.500" />
                      <StarIcon
                        color={review.rating >= 2 ? "blue.500" : "cyan.200"}
                      />
                      <StarIcon
                        color={review.rating >= 3 ? "blue.500" : "cyan.200"}
                      />
                      <StarIcon
                        color={review.rating >= 4 ? "blue.500" : "cyan.200"}
                      />
                      <StarIcon
                        color={review.rating >= 5 ? "blue.500" : "cyan.200"}
                      />
